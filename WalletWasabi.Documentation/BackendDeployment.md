...
pgrep -ilfa tor && pgrep -ilfa groestlcoin && pgrep -ilfa wasabi && pgrep -ilfa nginx
...
```
# GroestlMix backend
# GroestlMix runs with the user called user
user    soft nofile 16384
user    hard nofile 16384
# End of GroestlMix backend
```
...
IMPORTANT! Press N otherwise it will replace the torrc with a default version and bye GroestlMix hidden service
```

# 5. Install, Configure and Synchronize groestlcoind (Groestlcoin Core)
...
****************************************************************************
*** Attention! GroestlMix PRODUCTION server                                  ***
****************************************************************************
EOS
```

...
namespace WalletWasabi.Gui
{
	...
	public class Config : ConfigBase
	{
		...
		public Network Network { get; internal set; } = NBitcoin.Altcoins.Groestlcoin.Instance.Mainnet;

		[DefaultValue("http://6brsrbiinpc32tfc.onion/")]
		...
		[DefaultValue("http://4ob2v2hpht6krdta.onion/")]
		...
		[DefaultValue("https://groestlcoin.org/")]

...
namespace WalletWasabi.Hwi.Parsers
{
	public static class HwiParser
	{
		...
		public static BitcoinAddress ParseAddress(string json, Network network)
		{
			...
			{
				network = NBitcoin.Altcoins.Groestlcoin.Instance.Testnet;
			}
			...
			if (JsonHelpers.TryParseJToken(json, out JToken token))
			{
				...
				{
					BitcoinAddress.Create(addressString, network == NBitcoin.Altcoins.Groestlcoin.Instance.Mainnet ? NBitcoin.Altcoins.Groestlcoin.Instance.Testnet : NBitcoin.Altcoins.Groestlcoin.Instance.Mainnet);
